...
const AuthScreen = () => {
	...
	// Handle form submit: navigate to signup with email as query
	const handleFormSubmit = (e) => {
		e.preventDefault(); // Prevent page reload
		navigate("/signup?email=" + email); // Redirect to signup with email
	};
			...
			<div className='py-10 bg-black text-white'>
				<div className='flex max-w-6xl mx-auto items-center justify-center flex-col-reverse md:flex-row px-4 md:px-2'>
					...
					<div className='flex-1 text-center md:text-left'>
						...
						<p className='text-lg md:text-xl'>
							Let kids enjoy adventures with their favorite characters—free with your membership.
						</p>
					</div>
				</div>
			</div>
